...
class postModel{
    ...
    static var collection: DatabaseReference{
        ...
        get {
            ...
            return Database.database(url: "https://instagram-clone-53fd6-default-rtdb.europe-west1.firebasedatabase.app").reference().child("posts")
    ...
    static func deletePost (id: String){
        ...
        postModel.collection.child(id).removeValue()
        
        CommentsModel.collection.child(id).removeValue()
        
        LikesModel.collection.child(id).removeValue()
        
        if let userId = Auth.auth().currentUser?.uid{
        
            UserModel.personalFeed.child(userId).child(id).removeValue()
