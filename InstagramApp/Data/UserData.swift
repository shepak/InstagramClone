...
class UserModel {
    ...
    static var collection: DatabaseReference{
        ...
        get {
            ...
            return Database.database(url: "https://instagram-clone-53fd6-default-rtdb.europe-west1.firebasedatabase.app").reference().child("users")
        }
    ...
    static var personalFeed: DatabaseReference{
        ...
        get {
            ...
            return Database.database(url: "https://instagram-clone-53fd6-default-rtdb.europe-west1.firebasedatabase.app").reference().child("user_posts")
